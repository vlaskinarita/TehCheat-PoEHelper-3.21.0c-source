...
public class ActiveAnimationData : StructuredRemoteMemoryObject<ActiveAnimationOffsets>
{
	...
	public float? AnimationSpeed
	{
		get
		{
			if (base.Structure.SlowAnimationStartStageMinus8Ptr != 0L)
			{
	...
	public AnimationStage SlowAnimationStartStage => GetObject<AnimationStage>(base.Structure.SlowAnimationStartStageMinus8Ptr + 8);

	public AnimationStage SlowAnimationEndStage => GetObject<AnimationStage>(base.Structure.SlowAnimationEndStageMinus8Ptr + 8);
