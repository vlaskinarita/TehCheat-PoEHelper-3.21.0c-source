...
public abstract class BaseIcon
{
	...
	public BaseIcon(Entity entity, ISettings settings)
	{
		...
		string name = Entity.GetComponent<MinimapIcon>().Name;
		...
		{
			Transitionable transitionable = Entity.GetComponent<Transitionable>();
			Text = RenderName;
		...
		else if (Entity.Path.StartsWith("Metadata/Terrain/Labyrinth/Objects/Puzzle_Parts/Switch", StringComparison.Ordinal))
		{
			Show = delegate
			{
				Transitionable component3 = baseIcon.Entity.GetComponent<Transitionable>();
				MinimapIcon component4 = baseIcon.Entity.GetComponent<MinimapIcon>();
				return baseIcon.Entity.IsValid && component4.IsVisible && !component4.IsHide && component3.Flag1 != 2;
			};
		}
		else if (Entity.Path.StartsWith("Metadata/MiscellaneousObjects/Abyss/Abyss"))
		{
			Show = delegate
			{
				...
				return baseIcon.Entity.IsValid && component2.IsVisible && (!component2.IsHide || baseIcon.Entity.GetComponent<Transitionable>().Flag1 == 1);
			};
		}
