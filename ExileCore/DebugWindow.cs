	...
	public void Render()
	{
		...
		try
		{
			if ((bool)settingsCoreSettings.ShowLogWindow)
			{
				...
				{
					ImGui.SetNextWindowPos(new System.Numerics.Vector2(10f, 10f), ImGuiCond.Appearing);
					ImGui.SetNextWindowSize(new System.Numerics.Vector2(600f, 1000f), ImGuiCond.Appearing);
