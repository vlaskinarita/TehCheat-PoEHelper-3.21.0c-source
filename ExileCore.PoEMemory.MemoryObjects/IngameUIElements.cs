...
public class IngameUIElements : Element
{
	...
	public Element PurchaseWindowHideout => GetObject<Element>(IngameUIElementsStruct.PurchaseWindowHideout);
	...
	public Element ChatPanel => GetObject<Element>(IngameUIElementsStruct.ChatBox);

	public Element ChatTitlePanel => ChatPanel.ReadObjectAt<Element>(768);

	public PoeChatElement ChatBox => ChatPanel.ReadObjectAt<Element>(816).ReadObjectAt<PoeChatElement>(912);

	public IList<string> ChatMessages => ChatPanel.GetChildFromIndices(1, 2, 1).Children.Select((Element x) => x.Text).ToList();
	...
	public ArchnemesisPanelElement ArchnemesisInventoryPanel => GetObject<ArchnemesisPanelElement>(0L);

	[Obsolete("Removed from the game")]
	public ArchnemesisAltarElement ArchnemesisAltarPanel => GetObject<ArchnemesisAltarElement>(0L);

	public Element TreePanel => GetObject<Element>(IngameUIElementsStruct.TreePanel);

	public Element AtlasTreePanel => GetObject<Element>(IngameUIElementsStruct.AtlasSkillPanel);
	...
	public Element HelpWindow => GetObject<AtlasPanel>(IngameUIElementsStruct.HelpWindow);
	...
	[Obsolete("Removed from the game")]
	public HarvestWindow HarvestWindow => GetObject<HarvestWindow>(0L);
