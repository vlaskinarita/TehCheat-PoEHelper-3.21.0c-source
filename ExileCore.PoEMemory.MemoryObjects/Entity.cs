...
public class Entity : RemoteMemoryObject
{
	...
	internal static uint ID_OFFSET = 96u;
	...
	public uint Id
	{
		get
		{
			long? num = (_id = _id ?? base.M.Read<uint>(base.Address + ID_OFFSET));
	...
	public uint InventoryId
	{
		get
		{
			uint? num = (_inventoryId = _inventoryId ?? base.M.Read<uint>(base.Address + 112));
			return num.Value;
		}
	}
